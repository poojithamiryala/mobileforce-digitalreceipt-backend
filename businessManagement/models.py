...
class Receipts(models.Model):
    ...
    receipt_number = models.CharField(
        null=True, max_length=1000)  # need to customize this
    ...
    signature = models.URLField(max_length=1000, null=True, default=False)
    customer = models.ForeignKey(
        CustomerDetails, on_delete=models.CASCADE, null=False)
