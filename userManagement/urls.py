...
from .views import user_registration_send_email, create_user, login, change_password,check_if_user_exists,create_notification,send_notification_now,logout
